...
const collapseItems = [
  ...
  {
    key: "2",
    label: " Колко време отнема почистването?",
    children: (
      <p>
  ...
  {
    key: "3",
    label: "Какво да правя, ако не съм доволен от почистването?",
    children: (
      <p>
  ...
  {
    key: "4",
    label: "Как се осигурява качеството на почистването?",
    children: (
      <p>
  ...
  {
    key: "5",
    label: "Как мога да направя резервация?",
    children: (
      <p>
  ...
  {
    key: "6",
    label: "Работите ли през почивните дни?",
    children: (
      <p>
